...
public class CityPageActivity extends AppCompatActivity {
    ...
    Button wikipediaBtn,airportBtn, weatherBtn ,hotelBtn, RestauBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hotelBtn = findViewById(R.id.HotelsBtn);
        RestauBtn = findViewById(R.id.RestauBtn);
        ...
        hotelBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Link = "https://www.google.com/maps/search/"+cityName+"nearest+hotel/@";
                Uri web = Uri.parse(Link);
                Intent goToWiki = new Intent(Intent.ACTION_VIEW, web);
                if(goToWiki.resolveActivity(getPackageManager())!=null){
                    startActivity(goToWiki);
        ...
        //go to restaurant.
        RestauBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Link = "https://www.google.com/maps/search/"+cityName+"nearest+restaurant/@";
                Uri web = Uri.parse(Link);
                Intent goToWiki = new Intent(Intent.ACTION_VIEW, web);
                if(goToWiki.resolveActivity(getPackageManager())!=null){
                    startActivity(goToWiki);

...
//...........................................Database Inserting part...................................................................
    ...
    public void insetDataCity(){
        SQLiteDatabase database = this.getReadableDatabase();
        String qry = "SELECT * FROM City WHERE COUNTRY =?";
        Cursor cursor = database.rawQuery(qry, new String[]{"Maroc"});
        ...
        if(cursor.getCount()>0) {
            ...
            contentValues1.put(CITY, "Rabat");
            contentValues1.put(COUNTRY, "Maroc");
            contentValues1.put(POPULATION,"577,827");
            contentValues1.put(AREA,"117 km2");

            database1.insert(DB_TABLE_CITY, null,contentValues1);

            contentValues1.put(CITY, "Casablanca");
            contentValues1.put(COUNTRY, "Maroc");
            contentValues1.put(POPULATION,"3.36 million");
            contentValues1.put(AREA,"384 km²");

            database1.insert(DB_TABLE_CITY, null,contentValues1);

            contentValues1.put(CITY, "Oujda");
            contentValues1.put(COUNTRY, "Maroc");
            contentValues1.put(POPULATION,"494,252");
            contentValues1.put(AREA,"96.4 km²");

            database1.insert(DB_TABLE_CITY, null,contentValues1);

            contentValues1.put(CITY, "Marrakesh");
            contentValues1.put(COUNTRY, "Maroc");
            contentValues1.put(POPULATION,"928,850");
            contentValues1.put(AREA,"230 km²");

            database1.insert(DB_TABLE_CITY, null,contentValues1);

            contentValues1.put(CITY, "Fes");
            contentValues1.put(COUNTRY, "Maroc");
